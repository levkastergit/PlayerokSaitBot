    ...
    <div className="tab-page">
      <div className="tab-page-header">
        ...
        <p className="tab-page-description">
          Товары с включённым автовыставлением (из активных и завершённых). Откройте лот и включите автовыставление в настройках.
        </p>
      </div>

      <div className="tab-grid">
        <section className="card" style={{ gridColumn: '1 / -1' }}>
          <h2 className="card-title">Товары с автовыставлением</h2>
          ...
          {hasToken && !loadingLots && !errorLots && filteredLots.length === 0 && (
            <p className="card-text">
              Пока нет лотов с включённым автовыставлением. Откройте лот во вкладке «Активные» или «Завершенные» и включите автовыставление в настройках товара.
            </p>
          )}
