...
function createFetchInProgressDealsFromPlayerok({ getViewer, requestDealsPage }) {
  ...
  return async function fetchInProgressDealsFromPlayerok(token, userAgent) {
...
module.exports = { createFetchInProgressDealsFromPlayerok }
