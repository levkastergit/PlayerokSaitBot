  ...
  if (req.method === 'POST' && pathname === '/api/playerok/autolist-tick') {
    ...
    const result = await runWithPlayerokUser(effectiveUserId, () =>
      ...
      deps: {
        ...
        autolistGetSwizzyerFlowMap: deps.autolistGetSwizzyerFlowMap,
        autolistPruneSwizzyerFlowMap: deps.autolistPruneSwizzyerFlowMap,
        processActiveSwizzyerFlows: deps.processActiveSwizzyerFlows,
        processSingleSwizzyerFlow: deps.processSingleSwizzyerFlow,
        autolistGetPartnerGptFlowMap: deps.autolistGetPartnerGptFlowMap,
        autolistPrunePartnerGptFlowMap: deps.autolistPrunePartnerGptFlowMap,
        processActivePartnerGptFlows: deps.processActivePartnerGptFlows,
        processSinglePartnerGptFlow: deps.processSinglePartnerGptFlow,
