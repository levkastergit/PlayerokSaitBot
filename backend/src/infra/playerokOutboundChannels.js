...
const PLAYEROK_OUTBOUND_CHANNELS = [
  ...
  },
  {
    ...
    label: 'Чаты',
    hint:
      'Список чатов, сообщения, отправка в чат, автодоставка. Здесь выбор работает даже при включённой общей ротации: ' +
      'конкретный IP = ВЫДЕЛЕННЫЙ под чаты (изолирован от 429 других категорий), «Чередование» = крутить по кругу.',
  },
  {
    id: 'deals',
    label: 'Сделки',
